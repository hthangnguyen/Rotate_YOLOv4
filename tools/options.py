...
class TrainOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--weights_path", type=str, default="pretrained/yolov4.pth", help="path to pretrained weights file")
        ...
        self.parser.add_argument("--img_size", type=int, default=640, help="size of each image dimension")
